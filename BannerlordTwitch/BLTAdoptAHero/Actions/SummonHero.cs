...
namespace BLTAdoptAHero
{
    ...
    internal class SummonHero : HeroActionHandlerBase
    {
        ...
        public class SimpleAgentOrigin : IAgentOriginBase
        {
            ...
            public bool IsInSameArmyAsPlayer => _isOnPlayerSide; // new interface member added in this game version
        ...
        // AddHeroToShip and SummonInNavalBattle removed (NonWarsails)
        ...
        // Game 1.3.15 still has the old concrete MissionAgentSpawnLogic class directly (pre-1.4.x
        // refactor into IMissionAgentSpawnLogic/DefaultBattleMissionAgentSpawnLogic).
